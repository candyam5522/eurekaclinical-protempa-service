...
public final class PropositionDefinitionConverterVisitor implements
	...
	private final FrequencyValueThresholdConverter frequencyValueThresholdConverter;
        private final PhenotypeFieldConverterHelper phenotypeFieldConverterHelper;
	@Inject
	public PropositionDefinitionConverterVisitor(SystemPropositionConverter inSystemPropositionConverter,
			...
			FrequencyValueThresholdConverter inFrequencyHighLevelAbstractionConverter,
                        PhenotypeFieldConverterHelper inPhenotypeFieldConverterHelper) {
	...
	public boolean addPropositionId(String propId) {
        ...
        public void setAllCustomPhenotypes(List<Phenotype> phenotypes){
            this.phenotypeFieldConverterHelper.setAllCustomPhenotypes(phenotypes);
        }

	@Override
	public void visit(SystemPhenotype entity) {
	...
	@Override
	public void visit(Sequence entity) throws PhenotypeHandlingException {
	...
	@Override
	public void visit(ValueThresholds entity) throws PhenotypeHandlingException {
	...
	public void visit(Frequency entity) {
		if (entity.getPhenotype().getType() == Phenotype.Type.VALUE_THRESHOLD) {
			this.propositionDefinitions = 
        ...
        @Override
	public void visit(PhenotypeField peField) throws PhenotypeHandlingException {
            Phenotype pe = this.phenotypeFieldConverterHelper.getPhenotype(peField.getPhenotypeKey());
            pe.accept(this);
        }
}
